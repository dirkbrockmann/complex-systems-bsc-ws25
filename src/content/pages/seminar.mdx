...
<Quote 
  ...
  cite="Physics Nobel Price 1965" 
  quote="If you cannot explain something in simple terms, you don't understand it." 
/>
...
The Complexity Explorables site hosts 49 explorables, not
all of which are suitable for this course. Below is a list
of the subset of explorables you can choose from. Once
you have made your selection, I'll add your name to the list.
